...
- **eng-harness-2-backpressure (this skill, alias `/plan-2d`)** surveys the **computational** tier *before* architecture: can the work be *proven deterministically*, and if not, should we build the sensor first?
