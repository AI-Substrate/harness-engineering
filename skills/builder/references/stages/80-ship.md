...
node_modules/.bin/ddocs get "${ARCHIVE}/plan.dd.json#acceptance_criteria" # the closed criteria + their receipts
node_modules/.bin/ddocs graph map "${ARCHIVE}/plan.dd.json#acceptance_criteria/ac-XXXX" --direction in
```
