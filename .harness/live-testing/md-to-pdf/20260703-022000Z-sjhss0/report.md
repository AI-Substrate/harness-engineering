...
- **Subject**: claude · claude-sonnet-5 · high · session `pij-1sjhss0`
- **Base ref**: v0.6.0
...
- **Run**: 20260703-022000Z-sjhss0 (2026-07-03T02:20:00.872Z → 2026-07-03T02:20:04.086Z)
- **Resolved commands** (`--resolve`): A7=node harness/cli/bin/harness.js md-to-pdf --help · A8=node harness/cli/bin/harness.js md-to-pdf scratch/eval-sample.md --json
...
- **backpressure_quality** (A11): backpressure design quality (orchestrator-judged)
  ...
  - rationale: Deterministic render-fidelity sensor: mermaidFound vs mermaidRendered counts via real mmdc Chromium renders, and ok/exit0 only after pdf-lib actually re-parses the produced PDF (real parse, not magic-byte sniff). Hand-verified labels present as vector text via pdftotext.
