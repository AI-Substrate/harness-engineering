...
4. At the end of the run, ask the agent "if you had a magic wand, what would you improve about your environment". Ask it to provide a retrospective of its experience of working with the codebase and the harness.
