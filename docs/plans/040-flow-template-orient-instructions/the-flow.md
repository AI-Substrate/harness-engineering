...
flowchart TD
    ...
    ship["Ship"]:::assumed
    phase_2["P2: orient verb"]:::known
    phase_3["P3: Renderer (type-colour/badges/legend)"]:::known
    phase_4["P4: the-flow skill (template/expander/invariant)"]:::known
    phase_5["P5: Doctrine-parity + coexistence"]:::known
    ...
    boot_2["Boot check"]:::chore
    observe_2["Observe: P2"]:::chore
    retro_2["Retro: P2 (drain)"]:::chore
    boot_3["Boot check"]:::chore
    observe_3["Observe: P3"]:::chore
    retro_3["Retro: P3 (drain)"]:::chore
    boot_4["Boot check"]:::chore
    observe_4["Observe: P4"]:::chore
    retro_4["Retro: P4 (drain)"]:::chore
    boot_5["Boot check"]:::chore
    observe_5["Observe: P5"]:::chore
    retro_5["Retro: P5 (drain)"]:::chore
    backpressure -.-> plan
    boot_1 -.-> phase_1
    observe_1 -.-> phase_1
    retro_1 -.-> phase_1
