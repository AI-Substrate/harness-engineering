...
**Kind**: flight-plan · **Now**: review-2 · **Next**: ship · **Intent**: a new eng-harness-flow command that reviews harness observations and retros across a plan or n-plans and reports the most valuable things to work on next to make engineering in the given repo better · **Nodes**: 15 · **Events**: 41
