...
**Kind**: flight-plan · **Now**: implement · **Next**: review · **Intent**: Standardise harness telemetry to the OTEL/OTLP standard for upstream ingestion; keep storing locally. Segments may be reshaped OTEL-native — no back-compat required (not shipped yet). · **Nodes**: 24 · **Events**: 51
