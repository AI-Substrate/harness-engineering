...
**Kind**: flight-plan · **Now**: phase-1 · **Next**: review-1 · **Intent**: Make builder + eng-harness-flow treat every token as gold: lean writing, lean build consumption, right-model/subagent delegation, and token-efficiency as a first-class harness-improvement target — measured against real telemetry (056 run as baseline) · **Nodes**: 16 · **Events**: 31
