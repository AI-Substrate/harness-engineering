...
**Kind**: flight-plan · **Now**: phase-1 · **Intent**: start new flow, get flow spine in please, then proceed to explore phase. then we go to workshops — Deterministic Documents (dd) per initial-brief.md · **Nodes**: 41 · **Events**: 57
...
flowchart TD
    ...
    plan["Plan 💬1 📝3"]:::done
    phase_1["P1: dd-core foundations 📝6"]:::wip
