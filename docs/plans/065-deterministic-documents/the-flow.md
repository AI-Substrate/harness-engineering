...
**Kind**: flight-plan · **Now**: phase-5 · **Intent**: start new flow, get flow spine in please, then proceed to explore phase. then we go to workshops — Deterministic Documents (dd) per initial-brief.md · **Nodes**: 41 · **Events**: 101
