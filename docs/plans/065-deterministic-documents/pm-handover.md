...
2. **`workshop-notes.md`** — THE authoritative rulings doc: decisions D1–D13 (each verbatim-quote grounded), open workshops W1–W10, and the three-tier validation lessons. Where this and anything else disagree, this wins.
