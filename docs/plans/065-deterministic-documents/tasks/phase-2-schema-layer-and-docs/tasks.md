...
flowchart TD
    subgraph P2["Phase 2 — schema layer & baked docs"]
        T001["T001 resolution fixture corpus"]:::pending --> T002["T002 package model + deep-scan resolver"]:::pending
        T008["T008 leaf rulings"]:::pending --> T002
        T002 --> T003["T003 enum + gate_terminal declarations"]:::pending
        T003 --> T004["T004 dd validate LIVE (OD-2 handoff)"]:::pending
        T002 --> T005["T005 schema list/show bodies"]:::pending
        T002 --> T006["T006 exemplar builder/* packages"]:::pending
        T008 --> T007["T007 baked docs + drift scripts"]:::pending
        T004 --> T009["T009 validation & proof"]:::pending
        T005 --> T009
        T006 --> T009
        T007 --> T009
    end
