...
flowchart TD
    subgraph P6["Phase 6 — flow-spine gating (terminal)"]
        T001["T001 gate-matrix fixtures"]:::pending --> T002["T002 dd_link field"]:::pending
        T002 --> T003["T003 gate eval in setNow/runMutation"]:::pending
        T003 --> T004["T004 basis recording + drift warning"]:::pending
        T003 --> T005["T005 surfacing: orient/rail/render"]:::pending
