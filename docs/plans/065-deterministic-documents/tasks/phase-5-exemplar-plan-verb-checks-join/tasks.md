...
| 2026-08-04 | T004 | Noteworthy | The three duplicated issue-class -> E-code maps had ALREADY drifted: `address-path-escape` answered to E405 in one verb and E430 in another | One exported map; the specific code wins. Behaviour change to a filled body, flagged for review | execution.log.md § T004 |
