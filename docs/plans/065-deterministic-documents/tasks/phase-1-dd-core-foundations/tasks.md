...
flowchart TD
    ...
    subgraph Phase1["Phase 1: dd-core foundations"]
        T001["T001 fixtures"]:::completed --> T002["T002 model+parse"]:::completed
        T002 --> T003["T003 address"]:::completed
        T002 --> T004["T004 validate classes"]:::completed
        T003 --> T004
        T004 --> T005["T005 depth+exclusion"]:::completed
        T002 --> T010["T010 deriveState"]:::completed
        T006["T006 E4xx block"]:::completed --> T007["T007 act stubs+wire"]:::completed
        T004 --> T007
        T007 --> T008["T008 isolation rules"]:::completed
        T009["T009 leaf rulings"]:::completed --> T002
        T009 --> T003
        T009 --> T010
    end
```
