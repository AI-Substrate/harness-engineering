...
flowchart TD
    subgraph P3["Phase 3 — render, adapters & freshness"]
        T001["T001 golden corpus + fixtures"]:::completed --> T002["T002 pure renderer"]:::completed
        T006["T006 leaf rulings"]:::completed --> T002
        T002 --> T003["T003 dd build + --check drift"]:::completed
        T001 --> T004["T004 adapter pipeline"]:::completed
        T004 --> T003
        T003 --> T005["T005 live-ledger refresh + WatcherPort"]:::completed
        T003 --> T007["T007 validation & proof"]:::completed
        T005 --> T007
    end
```
