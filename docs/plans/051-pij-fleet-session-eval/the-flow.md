...
**Kind**: flight-plan · **Now**: plan · **Next**: phase-1 · **Intent**: Eval pij fleets as one joined session: orchestrator builds flow artifacts, spawns pij coders/reviewer, joins child sessions via captured parent-link env vars, scores time/quality/cost per named scenario (each scenario carries its reason/vibe) · **Nodes**: 11 · **Events**: 14
