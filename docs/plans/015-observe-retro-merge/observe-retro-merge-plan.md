...
|--------|-----|------|--------|---------|-----------|-------|
| [ ] | T000 | **Harness boot pre-flight** — `just test` + `npx harness doctor --json` | — | — | Suite green (~317 tests), doctor `ok`, extensions 2 loaded | Harness loop (L3); `/plan-6` auto-fires |
