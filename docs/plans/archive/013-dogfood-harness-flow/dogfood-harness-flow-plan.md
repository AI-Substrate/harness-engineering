...
| [FX004](fixes/FX004-onboarding-experience-test.md) | 2026-06-10 | Worker prompt is a 256-line runbook — the test proves runbook execution, not onboarding; grading is self-report; documented entry-point skills not mounted | agents, dogfood extensions, skills, docs | **Implemented 2026-06-10** (`5fa96b0`…`7d705eb` + bookkeeping; dossier validated via validate-v2, 3 agents) — E2E smoke PASS on chalk: goal-briefed worker found README → skills → assess → boot → observe → retro unaided; probes 7/8 ✓, zero discrepancies; skills-local ✗ surfaced as a design finding (setup Step 4 is human-gated opt-in — SUGG-005), 4 findings total SUGG-003…006, none auto-implemented | User direction + 015 observations SUGG-001/SUGG-002 (FX003 stays reserved for the FX001-spun stale-docs candidate) |
