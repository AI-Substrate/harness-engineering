...
|--------|-----|------|--------|---------|-----------|-------|
| [x] | T000 | **Harness pre-flight** — `/eng-harness-flow --event pre-implement --phase "Implementation" --plan-dir docs/plans/019-harness-update --json` | — | — | Router envelope handled; verdict narrated verbatim before code | _Harness seam — advisory, router installed; never a gate_ |
