# Cursor prompt 5 — round two, mixed commit
...
including anything that looks unfinished or oddly styled.

Do exactly this:

1. Create `AI2.md` — three or four lines describing what this repo is for.
2. Add `export const three = 3;` to the **end** of `seed.mjs`.
3. Stage **everything**: `git add -A` — this will include changes you did not make, and that
   is intended.
4. Commit with the message: `feat: AI2.md and three (round two)`
