...
flowchart TD
  ...
  subgraph companion3["🤖 code-review-companion · Phase 3 · APPROVE (0 findings)"]
    p3["Phase 3 · CI + release + branch protection · BUILT"]:::done
  end
  merge["Merge"]:::known
  ...
  said_p2 -.- p2
  said_p3>"🗣 add forward note; run the /5 then validate; live review"]:::done
  said_p3 -.- p3
```
