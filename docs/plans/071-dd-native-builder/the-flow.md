...
**Kind**: flight-plan · **Now**: phase-2 · **Next**: review-1 · **Intent**: Make the builder pipeline dd-native: plans and task files as .dd.json, flow gates driven by document state, typed rels, semantic validate with strict-zero --complete, PR evidence surface — the flow that delivers this plan is the feature itself · **Nodes**: 22 · **Events**: 46
