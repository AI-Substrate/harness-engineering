...
**Kind**: flight-plan · **Now**: phase-3 · **Next**: phase-3 · **Intent**: Harness telemetry collection — per-command sensor emitting normalized per-session segments (tokens/skills/tools/subagents/files/plan-links) committed to an orphan git ref for eng-thrive; Claude + Copilot adapters, Cursor later · **Nodes**: 8 · **Events**: 41
