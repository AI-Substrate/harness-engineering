...
**Kind**: flight-plan · **Now**: phase-2 · **Next**: phase-2 · **Intent**: Harness telemetry collection — per-command sensor emitting normalized per-session segments (tokens/skills/tools/subagents/files/plan-links) committed to an orphan git ref for eng-thrive; Claude + Copilot adapters, Cursor later · **Nodes**: 8 · **Events**: 34

**Rail**: ◆─◆─[ ◆─◇─◇─◇ ]─◇  ◆ Research · ◆ Plan · [ ◆ P1 Segment substrate & capture core · ◇ P2 Per-harness adapters · ◇ P3 Auto-capture kernel preamble · ◇ P4 Durable sync (gated §T1) ] · ◇ Ship
...
flowchart TD
    ...
    phase_2["P2 Per-harness adapters"]:::known
    phase_3["P3 Auto-capture kernel preamble"]:::known
    phase_4["P4 Durable sync (gated §T1)"]:::known
