...
**Kind**: flight-plan · **Now**: phase-5 · **Next**: ship · **Intent**: Harness telemetry collection — per-command sensor emitting normalized per-session segments (tokens/skills/tools/subagents/files/plan-links) committed to an orphan git ref for eng-thrive; Claude + Copilot adapters, Cursor later · **Nodes**: 10 · **Events**: 56

**Rail**: ◆─◆─[ ◆─◆─◆─◆─◐ ]─◇  ◆ Research · ◆ Plan · [ ◆ P1 Segment substrate & capture core · ◆ P2 Per-harness adapters · ◆ P3 Auto-capture kernel preamble · ◆ P4 Durable sync (§T1 ratified) · ◐ P5 Event-stream v2 (Amendment A2) ] · ◇ Ship
...
flowchart TD
    ...
    phase_5["P5 Event-stream v2 (Amendment A2)"]:::wip
