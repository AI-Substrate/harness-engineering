...
**Kind**: flight-plan · **Now**: phase-4 · **Next**: phase-4 · **Intent**: Harness telemetry collection — per-command sensor emitting normalized per-session segments (tokens/skills/tools/subagents/files/plan-links) committed to an orphan git ref for eng-thrive; Claude + Copilot adapters, Cursor later · **Nodes**: 8 · **Events**: 45
...
flowchart TD
    ...
    phase_4["P4 Durable sync (§T1 ratified)"]:::known
