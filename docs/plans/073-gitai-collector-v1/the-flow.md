...
**Kind**: flight-plan · **Now**: plan · **Intent**: Git AI becomes the collector. v1: disable harness telemetry capture by default (not remove), harness doctor detects/installs a pinned+SHA-verified git-ai via our own cross-platform download, installs agent hooks, and re-checks later. No semantic/flow work. Fleet lineage dark until v2. · **Nodes**: 11 · **Events**: 4
