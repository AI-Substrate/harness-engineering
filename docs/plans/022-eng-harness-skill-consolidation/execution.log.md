...
| T007 bundled refs | ✅ | (this) | getting-started.md fully rewritten to the 2-skill surface (router + verbs/modules + kept peer); retired-slug refs scrubbed from governance-doc.md (×4) + maturity-assessment.md (×1) + coach.md Suggest example. **Zero of the 5 retired slugs across the whole consolidated skill**; bundle complete (12 files); modules still L1-clean; kept-peer slug retained intentionally in SKILL.md/00-routing.md/getting-started/governance-doc. |
