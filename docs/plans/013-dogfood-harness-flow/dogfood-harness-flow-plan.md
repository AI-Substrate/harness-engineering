...
| [FX004](fixes/FX004-onboarding-experience-test.md) | 2026-06-10 | Worker prompt is a 256-line runbook — the test proves runbook execution, not onboarding; grading is self-report; documented entry-point skills not mounted | agents, dogfood extensions, skills, docs | Open — dossier validated (validate-v2, 3 agents: ⚠️ VALIDATED WITH FIXES — ripple gaps fixed in-dossier; 2 agent-raised CRITICALs dispositioned as the Problem statement, not defects) | User direction + 015 observations SUGG-001/SUGG-002 (FX003 stays reserved for the FX001-spun stale-docs candidate) |
