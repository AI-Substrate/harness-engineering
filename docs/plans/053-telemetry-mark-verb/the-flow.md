...
# Flow · telemetry-mark-verb

**Kind**: flight-plan · **Now**: ship · **Next**: ship · **Intent**: Add a harness telemetry mark verb: shape-guarded counts-only peer self-attestation onto its own telemetry lane (reviewer verdict first, mechanical per-stage spine later) · **Nodes**: 10 · **Events**: 17
