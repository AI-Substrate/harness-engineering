...
**Kind**: flight-plan · **Now**: plan · **Intent**: Upgrade harness to consume standalone @ai-substrate/dd (git-sha route) in place of the in-repo dd implementation; round-3 primitive-sufficiency trial decides OQ-2 · **Nodes**: 12 · **Events**: 12
