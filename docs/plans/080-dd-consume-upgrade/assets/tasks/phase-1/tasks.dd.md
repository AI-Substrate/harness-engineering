...
| id | assertion | state | pressure |
| --- | --- | --- | --- |
| dw-0003 | the new integration spec fails when pointed at a package missing a public export (negative control) and passes at the pinned sha: pack shape, typed foreign-port injection, tracked===null, D7 drive-rooted resolution | [ ] unchecked | [bp-000e](../../backpressure.dd.md#rows) |
| dw-0004 | just build && just test green with the new spec in the suite | [ ] unchecked | [bp-0003](../../backpressure.dd.md#rows) |
