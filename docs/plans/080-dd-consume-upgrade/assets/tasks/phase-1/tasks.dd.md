...
| id | assertion | state | pressure |
| --- | --- | --- | --- |
| dw-0007 | git grep -nE "services/dd\|acts/dd\|\./dd/" across pr-body.ts and index.ts returns ONLY services/dd/plan imports (the bounded phase-2 remainder) - phase-1-scoped proof bp-000f, distinct from the phase-2 full-zero bp-0002 | [x] checked | [bp-000f](../../backpressure.dd.md#rows) |
| dw-0008 | just build && just test green after the rewire | [x] checked | [bp-0003](../../backpressure.dd.md#rows) |
