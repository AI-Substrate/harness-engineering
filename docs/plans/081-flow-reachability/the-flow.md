...
**Kind**: flight-plan · **Now**: phase-3 · **Intent**: P3: docs via coder, contract+handoff via PM; P1 retro-review + verb-seam window pending · **Nodes**: 21 · **Events**: 48
...
flowchart TD
    ...
    post_flight["Post-flight 📝3"]:::done
    ship["Ship 📝3"]:::done
