...
**Kind**: flight-plan · **Now**: ship · **Next**: ship · **Intent**: Telemetry: when an agent writes a file, store the file path and its KB size, so we can see which files agents wrote. · **Nodes**: 10 · **Events**: 17
