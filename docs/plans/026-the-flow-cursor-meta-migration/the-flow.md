...
**Kind**: flight-plan · **Cursor**: plan · **Next**: p1 · **Nodes**: 6 · **Events**: 33

**Rail**: ◆─◆─◆─◆─◇─◇  ws-migration · ws-nav · ws-guide · plan · p1 · merge

```mermaid
flowchart TD
    merge["Merge"]:::known
    p1["Phase 1 · Build nav/rail/zone + create --agent"]:::assumed
