...
flowchart TD
    ...
    subgraph Sensors["Safety + foundation (first)"]
        T001["T001 · hook+envelope snapshot"]:::test
        T002["T002 · E300–E309 block"]:::pending
        T003["T003 · gen:flows bundle"]:::pending
    end

    subgraph Schema["Schema + overlays"]
        T004["T004 · schema tests"]:::test
        T005["T005 · resolution tests"]:::test
        T006["T006 · flow-schema.ts impl"]:::pending
    end

    subgraph State["Service + state I/O"]
        T007["T007 · containment tests"]:::test
        T008["T008 · E308 legacy tests"]:::test
        T009["T009 · flow-service.ts impl"]:::pending
    end

    subgraph Mut["Mutations + events"]
        T010["T010 · event/comment/datetime tests"]:::test
        T011["T011 · insert-node algebra tests"]:::test
        T012["T012 · duck-typed event tests"]:::test
        T013["T013 · flow-mutations.ts impl"]:::pending
        T014["T014 · flow-events.ts impl"]:::pending
    end
