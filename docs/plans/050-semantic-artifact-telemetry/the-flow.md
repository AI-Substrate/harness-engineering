...
**Kind**: flight-plan · **Now**: ship · **Intent**: Semantic telemetry from flow artifacts: count fixes from reviews, phases from plans, workshop/research lengths etc, extracted at save/import time so files carry updated telem over time · **Nodes**: 11 · **Events**: 32
