...
>
> Run `node_modules/.bin/ddocs validate` on it from **this folder** and you get 5 warnings.
...
```bash
node_modules/.bin/ddocs build docs/how/dd/exemplar/custom-render/release.dd.json
```
...
- `node_modules/.bin/ddocs build --check` reporting no byte drift from this folder.
...
A related, smaller wrinkle: `node_modules/.bin/ddocs schema list` reports **no doc-folder
